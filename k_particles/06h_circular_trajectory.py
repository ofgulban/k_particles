...
OUTDIR = "/Users/faruk/Documents/temp-k_particles/06h_circular_trajectory"
DIMS = [128, 128]
...
for i in range(NUM_POINTS):
    ...
    for j in range(3):
        if j % 2 == 0:
            coords = generate_points_on_circle(CENTER, RADIUS+j*8, 0, 2*np.pi, NUM_POINTS)
        else:
            coords = generate_points_on_circle(CENTER, RADIUS+j*8, 2*np.pi, 0, NUM_POINTS)
