...
# -----------------------------------------------------------
def make_glider_init(N):
    """Provide size of NxN matrix for initial glider.  N must be >=48."""

    if N<48 :
        sys.exit("** ERROR: N must be >=48")
    ...
    A[15+23,15+9]    = 1
    A[15+23,15+11]   = 1
    A[15+24,15+10:15+12] = 1
    A[15+25,15+10]    = 1

    # shapeH  
    A[15+30,15+16]    = 1
    A[15+31,15+17:15+19] = 1
    A[15+32,15+16:15+18] = 1
